...
<form action="/../web/lem_menu/root/scripts/insert_internat.php" method="post" id="form">
...
<input style="margin-left:10px;" type="submit" class="submit" name="submit" value="Submit" >

...
foreach ($arr as $item)
{
    if (is_array($item))
    {
        ...
        echo '</select>';
        echo '<br>';
        // echo '<button type="button" onclick="generatePDF()">Export to PDF</button>';
        echo $close_box;
    }
    else
    {
...
// make the new button
let button_html = `<button type="button" onclick="generatePDF(${arg})" id="btn">Export to PDF</button>`;
